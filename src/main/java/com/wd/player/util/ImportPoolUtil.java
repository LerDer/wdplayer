...
public class ImportPoolUtil {
	...
	public static ThreadPoolExecutor getNewPool() {
		return new ThreadPoolExecutor(8, 12, 30,
				TimeUnit.SECONDS,
				new ArrayBlockingQueue<>(1000),
				new CustomThreadFactory(),
				new CustomRejectedExecutionHandler());
	...
	private static class CustomThreadFactory implements ThreadFactory {
		...
		public Thread newThread(Runnable r) {
			...
			String threadName = ImportPoolUtil.class.getSimpleName() + count.addAndGet(1);
